...
static inline void gen_ibtc_stub(DisasContext *s, TCGv ibtc_guest_eip, TCGv ibtc_guest_eip2)
{
#ifdef ENABLE_IBTC
    if (s->env->gen_trace == 0) {
        TCGv_ptr ibtc_host_eip = tcg_temp_new_ptr();
        gen_helper_lookup_ibtc2(ibtc_host_eip, ibtc_guest_eip, ibtc_guest_eip2);
    ...
    case 2:                     /* FPU & Logical Operations */
        {
            ...
            if (xop == 0x3a) {  /* generate trap */
                ...
                gen_op_next_insn();
                gen_ibtc_stub(dc, cpu_pc, cpu_npc);
                tcg_gen_exit_tb(0);
                dc->is_br = 1;
                goto jmp_insn;
            } else if (xop == 0x28) {
                                                  ...
                                                  int spc, CPUSPARCState *env)
{
    ...
    if (env->gen_trace == 1 && tb->size != last_pc + 4 - pc_start) {
