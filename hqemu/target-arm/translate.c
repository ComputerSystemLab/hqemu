    ...
    if (unlikely(env->singlestep_enabled)) {
        ...
        case DISAS_UPDATE:
        {
            ...
            if (env->gen_trace == 0) {
                ...
                *gen_opparam_ptr++ = cpu_R[15];
                *gen_opparam_ptr++ = (tcg_target_long)(long)dc->tb;
#else
                TCGv_ptr ibtc_host_eip = tcg_temp_new_ptr();
                gen_helper_lookup_ibtc(ibtc_host_eip, cpu_R[15]);
