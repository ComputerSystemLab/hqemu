...
%.o: %.cpp
	$(call quiet-command,$(CXX) $(CXXFLAGS) $(QEMU_DGFLAGS) -c -o $@ $<,"  CXX   $(TARGET_DIR)$@")
...
LINK = $(call quiet-command,$(CXX) $(QEMU_CFLAGS) $(CFLAGS) $(LDFLAGS) -o $@ $(1) $(LIBS),"  LINK  $(TARGET_DIR)$@")
...
VPATH_SUFFIXES = %.c %.h %.S %.m %.mak %.texi %.cpp
